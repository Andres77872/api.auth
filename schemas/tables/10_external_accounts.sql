...
-- ===================================================================================
-- Durable Google OAuth identity links. The stable provider subject is stored only as
-- an application-computed HMAC plus a short non-reversible fingerprint for support.
...
SELECT 'External account tables created successfully!' AS status,
       '1 table created: user_external_accounts' AS details;
