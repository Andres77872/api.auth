...
-- =================== CREATE ROOT USER ===================
-- Create the first root user (password: 1248163264)
-- Password hash for '1248163264': 1be6588ad163643cae7ba7bbc6492c9fd035e01f1a1a9ed46e90f8c8ab3494c1
...
SELECT 'Root user created successfully!' as status, 
       'Username: root, Password: 1248163264' as credentials;
