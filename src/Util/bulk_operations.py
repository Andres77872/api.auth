...
from src.Util.db import (
    ...
    assign_user_to_permission_group, remove_user_from_permission_group,
    get_project_by_hash
)
...
class BulkOperations:
    ...
    @staticmethod
    def bulk_assign_roles(project_hash: str, role_assignments: List[Dict[str, Any]], assigned_by: int = None) -> Dict[str, Any]:
        """
