    ...
    def get_database_health() -> Dict[str, Any]:
        ...
        try:
            ...
            with get_connection() as con:
                ...
                # Get database size
                cur.execute("SELECT SUM(data_length + index_length) / 1024 / 1024 AS size_mb FROM information_schema.tables WHERE table_schema = DATABASE()")
            ...
            with get_connection() as con:
                ...
                cur.execute("""
                    SELECT AVG(member_count) FROM (
                        ...
                        WHERE up.is_active = 1 AND p.is_active = 1
                        GROUP BY p.id
                    ) AS project_members
                """)
